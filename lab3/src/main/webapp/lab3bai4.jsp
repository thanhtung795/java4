        ...
        <div class="col-md-8">
          <div class="card bg-l">
              ...
              <div class="card-body bg-secondary">
                <h2>${message}</h2>
                <h2>${error}</h2>
                <form role="form" class="form-horizontal" action="lab3bai4" method="post">
                  <div class="form-group row mb-3">
                    <label class="col-sm-2 col-form-label"  for="inputForm">
                      <span class="glyphicon glyphicon-user"></span> Form
                    </label>
                    <div class="col-sm-10">
                      <input type="email"   value="vothanhtung795@gmail.com" name = "form" class="form-control" id="inputForm"
                        placeholder="Form">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="inputTo">
