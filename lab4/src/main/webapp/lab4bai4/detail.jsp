...
<body>
	<div class="container">
		<div class="row">
		<a href = "${pageContext.request.contextPath}/lab4bai4/addCart">Giỏ hàng</a>
			<c:forEach var="item" items="${items}">
				<div class="col-md-4">
					<a
						href="${pageContext.request.contextPath}/lab4/lab4bai4/ctsp?name=${item.name}">
						<div class="card text-center bg-light">
							<div class="card-header">
								<h1>${item.name}</h1>
							</div>
							<div class="card-body">
								<img class="img-fluid" src="../lab4bai4/img/${item.img}" alt=""
									width="150">
