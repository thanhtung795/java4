...
@NamedQueries({
		...
		@NamedQuery(name = "Video.selectYear", query = "Select distinct year(o.likeDate) from Favorite o order by year(o.likeDate) desc") })
@Entity
@Table(name = "Videos")
public class Video {
	@Id
	...
	public Video(int id, String title, String poster, String description, Integer views, Boolean active,
			List<Favorite> favorites) {
		super();
		this.id = id;
		this.title = title;
