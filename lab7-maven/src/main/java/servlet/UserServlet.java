...
@WebServlet({ "/user/UserCRUD", "/user/search", "/user/filterRoleLab7", "/user/create", "/user/update", "/user/delete",
...
public class UserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (url.contains("create")) {
			...
			request.getRequestDispatcher("/view/UserCRUD.jsp").forward(request, response);
			return;
		} else if (url.contains("filterRoleLab7")) {
			filterRole(request, response);
			return;
	...
	private void filterRole(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
